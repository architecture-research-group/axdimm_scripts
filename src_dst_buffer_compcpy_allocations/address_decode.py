...
def wrcas(col_addrs, bg, ba, slot):
    ...
    print ("wrcas bg:{} ba:{} col:{}".format(''.join(bank_group), ''.join(bank_address), ''.join(column_address)))
...
def rdcas(col_addrs, bg, ba, slot):
    ...
    print ("rdcas bg:{} ba:{} col:{}".format(''.join(bank_group), ''.join(bank_address), ''.join(column_address)))
